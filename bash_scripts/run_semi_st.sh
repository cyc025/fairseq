...
SRC=box
TGT=summary
CORPUS_PATH=corpus/webnlg/10/original_data
MONO_SRC=corpus/webnlg/12876/original_data/train
MONO_TGT=corpus/webnlg/12876/original_data/train
...
cp $MONO_SRC.$SRC $ST_TRAIN_SRC_PATH
...
preprocess_tgt_only() {
    ...
    --thresholdtgt 0 \
    --thresholdsrc 0 \
    --srcdict $CORPUS_PATH/$CORPUS_DEST/dict.$TGT.txt \
    --joined-dictionary \
    --workers 70;
}
